...
C_SRCS += \
../src/ADC/DMA/adc_dma_test.c \
../src/ADC/DMA/debug_frmwrk.c 

OBJS += \
./src/ADC/DMA/adc_dma_test.o \
./src/ADC/DMA/debug_frmwrk.o 

C_DEPS += \
./src/ADC/DMA/adc_dma_test.d \
./src/ADC/DMA/debug_frmwrk.d 


# Each subdirectory must supply rules for building sources it contributes
src/ADC/DMA/%.o: ../src/ADC/DMA/%.c
	@echo 'Building file: $<'
