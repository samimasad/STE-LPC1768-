...
C_SRCS += \
../src/ADC/INTERRUPT/adc_interrupt_test.c \
../src/ADC/INTERRUPT/debug_frmwrk.c 

OBJS += \
./src/ADC/INTERRUPT/adc_interrupt_test.o \
./src/ADC/INTERRUPT/debug_frmwrk.o 

C_DEPS += \
./src/ADC/INTERRUPT/adc_interrupt_test.d \
./src/ADC/INTERRUPT/debug_frmwrk.d 


# Each subdirectory must supply rules for building sources it contributes
src/ADC/INTERRUPT/%.o: ../src/ADC/INTERRUPT/%.c
	@echo 'Building file: $<'
