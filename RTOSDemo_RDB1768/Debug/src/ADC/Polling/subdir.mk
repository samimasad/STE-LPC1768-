...
C_SRCS += \
../src/ADC/Polling/adc_polling_test.c \
../src/ADC/Polling/debug_frmwrk.c 

OBJS += \
./src/ADC/Polling/adc_polling_test.o \
./src/ADC/Polling/debug_frmwrk.o 

C_DEPS += \
./src/ADC/Polling/adc_polling_test.d \
./src/ADC/Polling/debug_frmwrk.d 


# Each subdirectory must supply rules for building sources it contributes
src/ADC/Polling/%.o: ../src/ADC/Polling/%.c
	@echo 'Building file: $<'
