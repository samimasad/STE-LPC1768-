...
C_SRCS += \
../src/EMAC/uIP/apps/hello-world/hello-world.c 

OBJS += \
./src/EMAC/uIP/apps/hello-world/hello-world.o 

C_DEPS += \
./src/EMAC/uIP/apps/hello-world/hello-world.d 


# Each subdirectory must supply rules for building sources it contributes
src/EMAC/uIP/apps/hello-world/%.o: ../src/EMAC/uIP/apps/hello-world/%.c
	@echo 'Building file: $<'
