...
C_SRCS += \
../src/UART/Interrupt/uart_interrupt_test.c 

OBJS += \
./src/UART/Interrupt/uart_interrupt_test.o 

C_DEPS += \
./src/UART/Interrupt/uart_interrupt_test.d 


# Each subdirectory must supply rules for building sources it contributes
src/UART/Interrupt/%.o: ../src/UART/Interrupt/%.c
	@echo 'Building file: $<'
