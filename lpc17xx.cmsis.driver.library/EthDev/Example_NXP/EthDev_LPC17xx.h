...
#define AHB_SRAM_BANK1_BASE  0x20080000
...
#define RX_DESC(i)   ((RX_DESC_TypeDef *)((RX_DESC_BASE  +         (2*4)*i)))
#define RX_STAT(i)   ((RX_STAT_TypeDef *)((RX_STAT_BASE  +         (2*4)*i)))
#define TX_DESC(i)   ((TX_DESC_TypeDef *)((TX_DESC_BASE  +         (2*4)*i)))
#define TX_STAT(i)   ((TX_STAT_TypeDef *)((TX_STAT_BASE  +         (1*4)*i)))
#define RX_BUF(i)    ((        uint8_t *)((RX_BUF_BASE   + ETH_FRAG_SIZE*i)))
#define TX_BUF(i)    ((        uint8_t *)((TX_BUF_BASE   + ETH_FRAG_SIZE*i)))
